                                  ...
                                  child: MouseRegion(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: CustomButton(
                                        ...
                                        borderSideColor: _isContactMeHovered
                                            ? AppColors.primaryCyan
                                            : AppColors.grey,
                                        borderRadius: SizeConfig.blockWidth * 5,
                                        backgroundColor: _isContactMeHovered
                                ...
                                RichText(
                                  text: TextSpan(
                                    ...
                                    children: [
                                      const TextSpan(
                                        text:
                                            'Building modern mobile apps with ',
                                      ),
                                      TextSpan(
                                        text: 'Flutter',
                                        style: TextStyle(
